...
def is_raw_rule(args, base_config):
    ...
    if (
        ...
        (args.platform == 'microsoft365defender' and args.sentinel_mde)) and
        ...
        args.platform in ['splunk', 'azure'] or
        (args.platform == 'microsoft365defender' and args.sentinel_mde)
    ):
        return False
...
def main(argv=None) -> None:
    ...
    if args.search:
        ...
        elif args.platform == "microsoft365defender" and not args.sentinel_mde:
