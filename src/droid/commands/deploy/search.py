"""Search command – search rules on the platform."""
...
@register_command("deploy", "search")
def search(
    ctx: typer.Context,
    ...
    export: bool = typer.Option(False, "--export", "-e", help="Also export rules after searching"),
) -> None:
    """Search in the platform using the rules."""
